...
export default function FirstHero() {
  ...
  useEffect(() => {
    ...
    if (window.innerWidth >= 768) {
      // Set initial state before animation only for larger screens
  ...
  return (
    <div
      ref={heroRef}
      className="second-hero w-full my-16 px-8 text-left md:text-left md:max-w-lg md:mx-0 mx-auto text-center"
    >
      {/* Heading */}
      <h1 className="pl-10px text-3xl md:text-4xl font-bold text-black underline font-walbaum mb-6 md:text-left text-center">
        Energize By Day. <br />
        Rejuvenate By Night.
      </h1>

      {/* Description */}
      <p className="pl-30px text-lg md:text-xl font-normal text-black leading-relaxed font-walbaum md:text-left text-center">
